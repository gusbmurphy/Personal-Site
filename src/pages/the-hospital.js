...
export default () => (
    <Text>
      <div>
        ...
        <p>
          <i>Sed dignissim lacinia nunc</i>. Class aptent taciti sociosqu ad
          litora torquent per conubia nostra, per inceptos himenaeos.{" "}
        ...
        <p>
          <i>Cras metus</i>. Nullam mauris orci, aliquet et, iaculis et, viverra
          ...
          . Integer nec odio. Praesent libero. <i>Integer id quam</i>. Sed
        ...
        <p>
          ...
          <i>Cras metus</i>. Mauris massa. Vestibulum lacinia arcu eget nulla.{" "}
          <b>Integer nec odio</b>. Class aptent taciti sociosqu ad litora
        ...
        <p>
          <i>Sed cursus ante dapibus diam</i>. Morbi lectus risus, iaculis vel,
        ...
        <p>
          Vestibulum sapien. Proin quam. <i>Mauris massa</i>. Etiam ultrices.{" "}
          <i>
            Morbi lectus risus, iaculis vel, suscipit quis, luctus non, massa
          </i>
          . Suspendisse in justo eu magna luctus suscipit. Sed lectus. Integer
          euismod lacus luctus magna. <b>Nam nec ante</b>. Quisque cursus, metus
        ...
        <p>
          ...
          Nulla facilisi. <b>In vel mi sit amet augue congue elementum</b>.
          Integer lacinia sollicitudin massa. Cras metus. Sed aliquet risus a
        ...
        <p>
          <i>In vel mi sit amet augue congue elementum</i>. Aenean laoreet.
          Vestibulum nisi lectus, commodo ac, facilisis ac, ultricies eu, pede.
          Ut orci risus, accumsan porttitor, cursus quis, aliquet eget, justo.
          Sed pretium blandit orci. <b>Integer lacinia sollicitudin massa</b>.
        ...
        <p>
          ...
          elementum imperdiet. <i>Aenean laoreet</i>. Duis sagittis ipsum.
          Praesent mauris. Fusce nec tellus sed augue semper porta.{" "}
          <i>Proin sodales libero eget ante</i>. Mauris massa. Vestibulum
        ...
        <p>
          ...
          <b>Nulla quis sem at nibh elementum imperdiet</b>. Aenean quam. In
          scelerisque sem at dolor.{" "}
          <b>Nulla quis sem at nibh elementum imperdiet</b>. Maecenas mattis.
