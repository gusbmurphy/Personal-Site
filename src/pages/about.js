...
export default () => (
  <Text>
    <p>
      ...
      <b>Lorem ipsum dolor sit amet, consectetur adipiscing elit</b>. Fusce nec
    ...
    <p>
      ...
      nunc egestas porttitor. <b>Curabitur tortor</b>. Morbi lectus risus,
      iaculis vel, suscipit quis, luctus non, massa. Fusce ac turpis quis ligula
      lacinia aliquet. Mauris ipsum. Nulla metus metus, ullamcorper vel,
      tincidunt sed, euismod in, nibh.{" "}
      <i>Lorem ipsum dolor sit amet, consectetur adipiscing elit</i>. Quisque
    ...
    <p>
      ...
      justo eu magna luctus suscipit. Sed lectus.{" "}
    </p>
    ...
    <p>
      ...
      <b>Morbi in ipsum sit amet pede facilisis laoreet</b>. Morbi mi.{" "}
      <b>Curabitur sit amet mauris</b>. Quisque nisl felis, venenatis tristique,
      dignissim in, ultrices sit amet, augue.{" "}
      <i>Integer euismod lacus luctus magna</i>. Proin sodales libero eget ante.
